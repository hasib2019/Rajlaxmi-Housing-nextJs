                ...
                <Tab.Container defaultActiveKey="first">
                  <div className="ltn__tab-menu ltn__tab-menu-3 text-center">
                    <Nav className="nav justify-content-center">
                      <Nav.Link eventKey="first">Rajlaxmi Wazed Tower 01 & 02</Nav.Link>
                      <Nav.Link eventKey="second">Rajlaxmi Plaza</Nav.Link>
                      <Nav.Link eventKey="third">Rajlaxmi Wasimohol</Nav.Link>
                      <Nav.Link eventKey="fourth">Rajlaxmi Rose Gurder</Nav.Link>
                      <Nav.Link eventKey="five"> Rajlaxmi Mir Plaza</Nav.Link>
                    </Nav>
                  </div>
                  <Tab.Content>
